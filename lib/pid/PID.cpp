 ...
 */
template <class T>
PIDController<T>::PIDController(double p, double i, double d, boost::function<T(void)> pidSource, boost::function<void(T)> pidOutput)
{
  _p = p;
  _i = i;
  _d = d;
 ...
 */
template <class T>
void PIDController<T>::setPIDSource(boost::function<T(void)> pidSource)
{
  _pidSource = pidSource;
}
 ...
 */
template <class T>
void PIDController<T>::setPIDOutput(boost::function<void(T)> pidOutput)
{
  _pidOutput = pidOutput;
}
